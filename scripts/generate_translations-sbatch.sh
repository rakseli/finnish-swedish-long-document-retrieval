#!/bin/bash
#SBATCH --job-name=generate_translations
...
apptainer exec --bind="/users,/projappl,/scratch,$LOCAL_SCRATCH" --nv $CONTAINER_PATH python ../src/generate_translations.py --exit_duration_in_mins 175 
